              ...
              child: Column(
                ...
                children: [
                  Icon(Icons.people_outline,
                      size: 80, color: AppColors.blackColor300),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Obx(() => Text(
                                    ...
                                    style:
                                        AppTextStyles.adaptiveText(context, 22)
                                            .copyWith(
                                                fontWeight: FontWeight.bold,
                                                color: AppColors.whiteColor)))
                              ],
                        ...
                        child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 8.h),
                                Obx(() => Text("${controller.totalUsers.value}",
                                    textAlign: TextAlign.center,
                                    style:
                                        AppTextStyles.adaptiveText(context, 22)
                                            .copyWith(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Obx(() => Text(
                                  ...
                                  textAlign: TextAlign.center,
                                  style: AppTextStyles.adaptiveText(context, 22)
                                      .copyWith(
                                          fontWeight: FontWeight.bold,
                                          color: AppColors.whiteColor)))
                            ],
