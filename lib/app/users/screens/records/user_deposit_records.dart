...
import 'package:leasure_nft/app/users/screens/records/controller/user_deposit_record_controller.dart';

class UserDepositRecords extends GetView<UserDepositRecordController> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<UserDepositRecordController>(
        init: UserDepositRecordController(),
